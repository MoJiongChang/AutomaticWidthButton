//
//  ViewController.m
//  AutomaticWidthButton
//
//  Created by gdshwhl007 on 17/3/16.
...
-(void)setTitlebar{
    ...
    UIView *statusBarView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, CurrentWidth, 20)];
    statusBarView.backgroundColor = [UIColor yellowColor];
    [self.view addSubview:statusBarView];
    
    UIView *tbg = [[UIView alloc]initWithFrame:CGRectMake(0, 20, CurrentWidth, 44)];
